...
import model.InventorySupplyModel;
import view.InventorySupplyView;

public class InventorySupplyController implements ActionListener {
	
	private InventorySupplyView view;
	private InventorySupplyModel model;
	private HomeController controller;
	
	public InventorySupplyController( HomeController controller, InventorySupplyModel model, InventorySupplyView view ) {
		this.view = view;
		this.model = model;
...
//						new InventorySupplyController( getController(), addMaterialModel, addMaterialView );
